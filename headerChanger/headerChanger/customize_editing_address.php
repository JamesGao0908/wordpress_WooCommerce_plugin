    ...
    <div class="row">
        ...
        <div class="full_address_2" style="display:none;">
            <form method="post" action="../action_insert_address" id="form1">
                ...
                <div><input id="address_navigate_form_6" type="text" name="phone" placeholder="请输入收货人联系方式" required/></div>
                <div><input id="address_navigate_form_7" type="text" name="postal-code" placeholder="请输入邮编"  style="box-shadow: 0px 0px 0px 1px rgba(0, 0, 0, 0.125)"/></div>
            </form>
        </div>
    </div>
</div>
